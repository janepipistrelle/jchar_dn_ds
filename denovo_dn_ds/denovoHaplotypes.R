...
#ref_range = "2176992-2178608" # groEL
...
if(any(duplicated(res[,1]))) warning(paste("The following contigs contained discontiguous BLAST matches:",paste(res[duplicated[res[,1]],1])))
