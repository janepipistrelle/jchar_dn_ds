...
setwd("$WORKDIR/velvet")
comid = c(1075:1166,1274:1284)
velvet_file = paste("$WORKDIR/velvet/C0000",comid,"_n1_contigs.fa.gz",sep="")
#velvet_file = paste("$WORKDIR/velvet/",formatC(1000*round(comid/1000),width=8,flag="0"),"/C0000",comid,"_contigs.fa.gz",sep="")
